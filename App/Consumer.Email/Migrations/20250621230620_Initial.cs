        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoEmail = table.Column<int>(type: "integer", nullable: false),
                    ...
                    Copias = table.Column<List<string>>(type: "text[]", nullable: false),
                    CopiasOcultas = table.Column<List<string>>(type: "text[]", nullable: false),
